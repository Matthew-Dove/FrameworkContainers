...
namespace FrameworkContainers.Network.HttpCollective.Models
{
    ...
    public sealed class WebClientOptions
    {
        ...
        public WebClientOptions(HttpClient httpClient) : this(CancellationToken.None, httpClient) { }

        public WebClientOptions(CancellationToken cancellationToken, HttpClient httpClient)
        {
